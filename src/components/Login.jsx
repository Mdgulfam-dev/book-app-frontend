...
const Login = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            setMessage("Please provide a valid email and passwords")
            console.log(error)
  ...
  return (
    ...
    <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <div>
         ...
         <p className='align=baseline font-medium mt-4 text-sm' >Haven't an account? Please Register <Link className='text-blue-500 hover:text-blue-700' to="/register">Register</Link> </p>
...
{/* {google sign in} */}
        ...
        <p className='mt-5 text-center text-gray-500 test-xs' >@2025 Book store. All rights reserved.</p>
